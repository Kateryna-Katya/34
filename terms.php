        ...
        <div class="container">
            ...
            <div class="legal-content">
                <div class="policy-hero-card terms-accent">
                    ...
                    <p>
                        Добро пожаловать на платформу <strong><?= $domainTitle ?></strong>! Настоящие Условия представляют собой юридически обязывающий договор. Используя наш ресурс, вы подтверждаете свое полное согласие с правилами нашей цифровой инфраструктуры.
                    </p>
                </div>
                ...
                <div class="legal-section">
                    ...
                    <p>
                        Мы предоставляем доступ к функционалу <strong><?= $fullDomain ?></strong>: инновационным материалам, AI-инструментам анализа карьеры и экспертным статьям. Платформа создана для помощи в вашем профессиональном апгрейде на рынке Франции и ЕС.
                    </p>
                </div>
                ...
                <div class="legal-section">
                    ...
                    <div class="rules-grid">
                        <div class="rule-item">
                            ...
                            <p>Запрещено использование ботов для парсинга контента <?= $domainTitle ?>.</p>
                        </div>
                        <div class="rule-item">
                            <i class="fas fa-user-times"></i>
                            <p>Запрещена передача доступа к личным консультациям третьим лицам.</p>
                        </div>
                        <div class="rule-item">
                            <i class="fas fa-bug"></i>
                            <p>Запрещены любые действия, угрожающие безопасности сайта.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="legal-section">
                    ...
                    <div class="property-block-modern">
                        <div class="property-icon">
                            <i class="fas fa-copyright"></i>
                        </div>
                        <div class="property-text">
                            <p>
                                Весь контент на <strong><?= $fullDomain ?></strong> (методологии, графики, текст и код) защищен авторским правом. Вам предоставляется ограниченная лицензия только для личного некоммерческого использования.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="legal-section">
                    <div class="warning-block-simple">
                        ...
                        <p>
                            Услуги предоставляются по принципу <strong>«как есть»</strong>. <?= $domainTitle ?> не несет ответственности за решения, принятые пользователем на основе материалов блога, или за временные технические сбои.
                        </p>
                    </div>
                </div>

                <div class="contact-footer-policy">
                    <h2>Связь с правовым отделом</h2>
                    <p>По вопросам условий использования или партнерства:</p>
