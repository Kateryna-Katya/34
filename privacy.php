            ...
            <div class="legal-content">
                <div class="policy-hero-card">
                    ...
                    <p>
                        ...
                        предоставляемые клиентами <strong><?= $domainTitle ?></strong> для оказания услуг по карьерному консультированию и взаимодействия в цифровой среде Европы.
                    </p>
                </div>

                <div class="policy-notice-box">
                    <p>
                        <strong><?= $domainTitle ?></strong> оставляет за собой право обновлять положения Политики. Предоставляя свои данные, вы даете полное согласие на их обработку в рамках нашей передовой цифровой инфраструктуры.
                    </p>
                </div>

                <h2>Порядок сбора и защиты</h2>
                <div class="storage-info-grid">
                    <div class="storage-card">
                        <i class="fas fa-history"></i>
                        <p>Срок хранения данных до <strong>75 лет</strong> согласно архивному регламенту.</p>
                    </div>
                    <div class="storage-card">
                        <i class="fas fa-shield-alt"></i>
                        <p>Применяем технологии нового поколения для защиты от утечек.</p>
                    </div>
                </div>

                <div class="data-collection-grid">
                    <div class="data-box">
                        <h3><i class="fas fa-laptop-code"></i> Техническая информация</h3>
                        <ul class="check-list">
                            <li>IP-адрес и лог времени доступа</li>
                            <li>Источники перехода на <?= $fullDomain ?></li>
                            <li>Параметры браузера и поведение на страницах</li>
                        </ul>
                    </div>
                    <div class="data-box">
                        <h3><i class="fas fa-address-book"></i> Персонализация</h3>
                        <ul class="check-list">
                            <li>Имя и контактные данные</li>
                            <li>История запросов на апгрейд карьеры</li>
                            <li>Информация об оказанных услугах</li>
                        </ul>
                    </div>
                </div>

                <div class="legal-block accent-blue">
                    <h2>Цели обработки данных</h2>
                    <ul class="styled-list">
                        <li>Предоставление доступа к AI-инструментам платформы.</li>
                        <li>Разработка стратегий роста на базе ваших пожеланий.</li>
                        <li>Информирование о решениях, которые меняют правила игры.</li>
                ...
                <p>
                    Файлы cookie помогают нам анализировать трафик и сохранять ваши предпочтения (регион Франция). Это делает работу с платформой <strong><?= $domainTitle ?></strong> максимально быстрой и удобной.
                </p>

                <div class="rights-block-footer">
                    <h2>Ваши права</h2>
                    <p>
                        Вы можете отозвать согласие или отредактировать данные в любой момент. Напишите нашей службе безопасности:
                    </p>
                    <a href="mailto:hello@<?= $fullDomain ?>" class="btn btn-primary">hello@<?= $fullDomain ?></a>
                </div>
            </div>
        </div>
    </section>
