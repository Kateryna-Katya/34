        ...
        <div class="container">
            ...
            <div class="legal-header">
                <div class="warning-badge">
                    ...
                    <span>Внимательно ознакомьтесь</span>
                </div>
            ...
            <div class="legal-content">
                ...
                <div class="legal-block">
                    ...
                    <p>
                        ...
                        <strong>пассивного дохода</strong> или прошлых результатов наших клиентов не гарантируют 
                        аналогичных результатов в будущем. Индивидуальные итоги зависят от множества факторов.
                    </p>
                </div>
                ...
                <div class="legal-block">
                    ...
                    <p>
                        Администрация сайта <strong><?= $fullDomain ?></strong> не несет ответственности за
                        любые прямые или косвенные убытки, решения или действия, предпринятые вами на основе 
                        информации с этого ресурса. Вся ответственность за использование методологий и программ 
                        лежит исключительно на пользователе.
                    </p>
                </div>

                <div class="legal-block risk-alert">
                    ...
                    <div>
                        ...
                        <p>
                            Любая деятельность, направленная на изменение финансового статуса, сопряжена с
                            риском. Платформа <strong><?= $domainTitle ?></strong> рекомендует провести
                            собственное исследование перед принятием любых решений.
                        </p>
                    </div>
                </div>
                ...
                <div class="legal-block agreement-box">
                    <p>
                        ...
                        сайт <strong><?= $domainTitle ?></strong>, вы подтверждаете, что вам исполнилось 18 лет, и вы
                        полностью принимаете условия данного дисклеймера. Предложение активно только в странах ЕС (Франция).
                    </p>
                </div>
            </div>
        </div>
